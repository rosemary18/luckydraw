...
const handlerUnLoad = () => {
    ...
    if (Object.keys(STATES.GAME).length > 0) localStorage.setItem("draw_game", stringify(STATES.GAME))
...
const Start = () => {
    ...
    // let x = prompt('Untuk melanjutkan, masukkan kata sandi.')
    // while (x != "centralevents") x = prompt('Kata sandi salah, periksa kembali.')
